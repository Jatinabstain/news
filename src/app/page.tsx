...
import NewsCardBigLeft from "./components/imageCardBigLeft";
import NewsList from "./components/newsList";
import NewsCardBigLeftSmall from "./components/imageCardBigLeftSmall";
import { NewsCardBigLeftInfoItem } from "@/types/newsCardBigLeftInfo";
import NewsCardBigLeftInfo from "./components/imageCardBigLeftInfo";
...
const newsCardTopItems: NewsCardTopItem[] = [
  ...
  { id: '2', img: indiaNews, tag: 'India', content: 'OPINION | Parliament\'s fight should not have gone to Police ', href: '#' },
          ...
          <div className="grid grid-rows-2 md:grid-flow-col gap-4 news_grids">
            <div className="row-span-2 bg-slate-600 col-span-2 news_grid">
              <Link href="#">
                ...
                />
                <p>PM Modi embarks on historic visit to Kuwait: First Indian Prime Minister tour in 43 years</p>
              </Link>
            </div>
            <div className="row-span-1 col-span-1 bg-slate-600 news_grid">
              <Link href="#">
                ...
                />
                <p>Madhya Pradesh: Four of a family die in fire at milk parlour-cum-residence in Dewas</p>
              </Link>
            </div>
            <div className="row-span-1 col-span-1 bg-slate-600 news_grid">
              <Link href="#">
                ...
                />
                <p>Germany: 2 dead, 68 injured in suspected attack at Magdeburg Christmas market, Saudi man arrested</p>
              </Link>
            </div>
            <div className="row-span-1 col-span-1 bg-slate-600 news_grid">
              <Link href="#">
                ...
                />
                <p>Jaipur tanker explosion: Death count rises to 14 as half of injured in critical condition</p>
              </Link>
            </div>
            <div className="row-span-1 col-span-1 bg-slate-600 news_grid">
              <Link href="#">
                ...
                />
                <p>Allu Arjun&apos;s Pushpa 2 enters Rs 1,000 cr club, earns THIS much on Day 16</p>
              </Link>
            </div>
          </div>
        </div>
